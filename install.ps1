...
# 4. Build OpenPaw
Write-Host "Building OpenPaw (this may take a few minutes)..." -ForegroundColor Cyan
cargo build --release
...
Write-Host "`nOpenPaw is ready! Run it anytime with: .\target\release\openpaw agent" -ForegroundColor Green
